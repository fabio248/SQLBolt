...
SELECT  mov.title,
    ...
    FROM movies mov
 JOIN boxoffice b
        ON b.movie_id = mov.id;

/*
    Exercise 2: List all movies and their ratings in percent
*/
SELECT  mov.title, (b.rating*10) AS percent
    FROM movies mov
 JOIN boxoffice b
        ON b.movie_id = mov.id;
...
*/
SELECT name,role, MAX(years_employed) FROM employees;
/*
...
*/
SELECT COUNT(*) AS total_number_artist
    FROM employees
  WHERE role = 'Artist';
/*
...
*/
SELECT role, SUM(years_employed) AS total_years_engineers
    FROM employees
  GROUP BY role
...
*/
SELECT  mov.director,
        SUM(box.domestic_sales + international_sales)
...
INSERT INTO movies
    ...
    VALUES (15,'Toy Story 4', '	John Lasseter', 2023,90);
/*
    Exercise 2:
*/
